<table id="withdrawreqtable" class="table table-bordered table-striped">
	...
	<tbody>		
		...
		<tr>
			...
			<td><?php if(isset($payment_method) && $payment_method == 1 ) { echo '<badge class="badge badge-pill badge-soft-info">Account Transfer</badge>'; } else if($payment_method == 2) { echo '<badge class="badge badge-pill badge-soft-info">PayTm Transfer</badge>'; } else if($payment_method == 3){ echo '<badge class="badge badge-pill badge-soft-info">Google Pay Transfer</badge>'; } else if($payment_method == 4) { echo '<badge class="badge badge-pill badge-soft-info">Phone Pay Transfer</badge>'; }?></td>
		</tr>
		...
		<?php if($payment_method != 1 ) { ?>
		<tr>
			<td><?php if($payment_method == 2 ) { echo 'PayTm Number'; } else if($payment_method == 3 ) { echo 'Google Pay Number'; }else if($payment_method == 4 ){ echo 'PhonePe Number' ;} ?></td>

<div class="page-content">
                    ...
                    <div class="bg-soft-primary">
                        <div class="row">
                            ...
                            <div class="col-5 align-self-end">
                                <img src="<?php echo base_url(); ?>adminassets/images/profile-img.png" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?php echo base_url(); ?>adminassets/images/users/avatar-1.jpg" alt=""
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="<?php echo base_url() . admin . '/un-approved-users-list'; ?>">
                                                <h5 class="font-size-15">
                                                    <?php if (isset($totalUnapprovedUsers)) echo $totalUnapprovedUsers; ?>
                                                </h5>
                                        ...
                                        <div class="col-6">
                                            <a href="<?php echo base_url() . admin . '/user-management'; ?>">
                                                <h5 class="font-size-15">
                                                    <?php if (isset($totalApprovedUsers)) echo $totalApprovedUsers; ?>
                                                </h5>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <select id="game_name" name="game_name" class="form-control getMarketBid">
                                                ...
                                                <option value="<?php echo $rs->game_id; ?>">
                                                    <?php echo $rs->game_name; ?></option>
                                                <?php }
													} ?>
                                            </select>
                                            <?php
    ...
    background-image: -webkit-gradient(linear, left top, right top, from(#ff3f70), to(#f73769));
    background-image: linear-gradient(to right, #ff3f70, #f73769);
    color: #fff;  border-radius: 20px;
">
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="text-white font-weight-medium">Users</p>
                    ...
                    <div class="col-md-4">
                        <div class="card mini-stats-wid"> <?php if ($this->session->userdata('admin_type') == 1) { ?>
                            <a href="<?php echo base_url() . admin . '/game-name'; ?>"> <?php } ?>
                                <div class="card-body" style="    background-image: -webkit-gradient(linear, left top, right top, from(#46a5f9), to(#0878dc));
    background-image: linear-gradient(to right, #46a5f9, #0878dc);
    color: #fff;  border-radius: 20px;">
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="text-white font-weight-medium">Games</p>
...
">
                                <div class="media">
                                    <div class="media-body">
                                        <p class="text-white font-weight-medium">Bid Amount</p>
                            ...
                            <div class="row">
                                <div class="form-group col-md-5">
                                    ...
                                    <select id="bid_game_name" name="bid_game_name" class="form-control">
                                        ...
                                        <?php if (isset($game_result)) {
												foreach ($game_result as $rs) { ?>
                                        <option value="<?php echo $rs->game_id; ?>"><?php echo $rs->game_name; ?>
                                        </option>
                                        <?php }
											} ?>
                                    </select>
                                ...
                                <div class="col-md-2_5">
                                    <div class="card border card_<?php echo $i; ?>">
                                        <div class="card-header bg-transparent card_<?php echo $i; ?>">
                                            <h5 class="my-0 text-primary">Total Bids <span
                                                    id="bid<?php echo $i; ?>">0</span></h5>
                                        </div>
                                        <div class="card-body">

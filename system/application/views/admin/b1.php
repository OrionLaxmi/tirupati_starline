                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="user_name" name="user_name" class="form-control">
                                        ...
                                        <option value="<?php echo $rs->user_id; ?>"><?php echo $rs->user_name; ?>
                                        </option>
                                    ...
                                    <div class="date-picker">
                                        <div class="input-group">
                                            <input class="datepicker-here form-control digits" type="text"
                                                data-language="en" value="<?php echo $date; ?>" name="from_date"
                                                id="from_date" placeholder="Select Date" data-position="bottom left">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="date-picker">
                                        <div class="input-group">
                                            <input class="datepicker-here form-control digits" type="text"
                                                data-language="en" value="<?php echo $date; ?>" name="to_date"
                                                id="to_date" placeholder="Select Date" data-position="bottom left">
                                        </div>
                                    </div>
                                </div>

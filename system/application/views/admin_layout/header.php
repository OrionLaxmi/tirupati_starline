<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <button type="button" class="btn btn-sm px-3 font-size-15 header-item waves-effect" id="vertical-menu-btn">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo base_url(); ?>adminassets/images/users/avatar-1.jpg" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ml-1" key="t-henry">Admin</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-right">

                    <a class="dropdown-item" href="<?php echo base_url() . admin . '/change-password'; ?>"><i
                            class="bx bx-user font-size-16 align-middle mr-1"></i> <span key="t-lock-screen">Change
                            Password</span></a>
                    <a class="dropdown-item d-block" href="<?php echo base_url() . admin . '/main-settings'; ?>"><i
                            class="bx bx-wrench font-size-16 align-middle mr-1"></i> <span
                            key="t-settings">Settings</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="#logoutModal" data-toggle="modal"><i
...
<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100"
        style="background-color: rgba(0, 0, 0, 0.35); font-size: 14px; font-family: poppins, sans-serif; color: rgb(15, 16, 19);">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li>
                    <a href="<?php echo base_url() . admin . '/dashboard'; ?>" class="waves-effect mm-active" style="
...
">
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="<?php echo base_url() . admin . '/starline-user-bid-history'; ?>">Bid History</a>
                        </li>
                        <li><a href="<?php echo base_url() . admin . '/starline-decleare-result'; ?>">Decleare
                                Result</a></li>
                        <li><a href="<?php echo base_url() . admin . '/starline-result-history'; ?>">Result History</a>
                        </li>
                        <li><a href="<?php echo base_url() . admin . '/starline-sell-report'; ?>">Starline Sell
                                report</a></li>
                        <li><a href="<?php echo base_url() . admin . '/starline-winning-report'; ?>">Starline Winning
                                report</a></li>
                        <li><a href="<?php echo base_url() . admin . '/starline-winning-prediction'; ?>">Starline
                                Winning Prediction</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="<?php echo base_url() . admin . '/galidisswar-user-bid-history'; ?>">Bid
                                History</a></li>
                        <li><a href="<?php echo base_url() . admin . '/galidisswar-decleare-result'; ?>">Decleare
                                Result</a></li>
                        <li><a href="<?php echo base_url() . admin . '/galidisswar-result-history'; ?>">Result
                                History</a></li>
                        <li><a href="<?php echo base_url() . admin . '/galidisswar-sell-report'; ?>">Sell Report</a>
                        </li>
                        <li><a href="<?php echo base_url() . admin . '/galidisswar-winning-report'; ?>">Winning
                                Report</a></li>
                        <li><a href="<?php echo base_url() . admin . '/galidisswar-winning-prediction'; ?>">Winning
                                Prediction</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="<?php echo base_url() . admin . '/customer-sell-report'; ?>">Customer Sell
                                Report</a></li>
                        <li><a href="<?php echo base_url() . admin . '/winning-report'; ?>">Winning Report</a></li>
                        <li><a href="<?php echo base_url() . admin . '/transfer-point-report'; ?>">Transfer Point
                                Report</a></li>
                        ...
                        <li><a href="<?php echo base_url() . admin . '/auto-deposite-history'; ?>">Auto Deposit
                                History</a> </li>
                    </ul>
                </li>
                <?php } ?>
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li><a href="<?php echo base_url() . admin . '/fund-request-management'; ?>">Fund Request</a>
                        </li>
                        <li><a href="<?php echo base_url() . admin . '/withdraw-request-management'; ?>">Withdraw
                                Request</a> </li>
                        <li><a href="<?php echo base_url() . admin . '/add-fund-user-wallet-management'; ?>">Add Fund
                                (User Wallet)</a> </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="<?php echo base_url() . admin . '/slider-images-management'; ?>">Slider Images</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        <li><a href="<?php echo base_url() . admin . '/notice-management'; ?>">Notice Management</a>
                        </li>
                        <li><a href="<?php echo base_url() . admin . '/send-notification'; ?>">Send Notification</a>
                        </li>
                    </ul>
                </li>

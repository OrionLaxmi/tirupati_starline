...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="<?php echo base_url(); ?>adminassets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url(); ?>adminassets/css/bootstrap2.css" id="bootstrap-style" rel="stylesheet"
        type="text/css" />
    <!-- Icons Css -->
    <link href="<?php echo base_url(); ?>adminassets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>adminassets/css/pe-icon-7-stroke.css" rel="stylesheet" type="text/css" />

    <link href="<?php echo base_url(); ?>adminassets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>adminassets/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css"
        rel="stylesheet" type="text/css" />
    <link
        href="<?php echo base_url(); ?>adminassets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>adminassets/libs/select2/css/select2.min.css" rel="stylesheet"
        type="text/css" />
    <!-- App Css-->
    <link href="<?php echo base_url(); ?>adminassets/css/app.min.css?v=2" id="app-style" rel="stylesheet"
        type="text/css" />
...
<body data-sidebar="dark">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                ...
                                <a href="<?php echo base_url() . admin . '/logout'; ?>"
                                    class="btn btn-info waves-effect waves-light">Logout</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="theme-form" id="withdrawapproveFrm" method="post" enctype="multipart/formdata">
                        ...
                        <input type="hidden" name="withdraw_req_id" id="withdraw_req_id"
                            value="<?php if (isset($withdraw_request_id)) echo $withdraw_request_id; ?>">
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="theme-form" id="withdrawRejectFrm" method="post" enctype="multipart/formdata">
                        ...
                        <input type="hidden" name="withdraw_req_id" id="r_withdraw_req_id"
                            value="<?php if (isset($withdraw_request_id)) echo $withdraw_request_id; ?>">
                        <div class="form-group">
    ...
    <!-- Buttons examples -->
    <script src="<?php echo base_url(); ?>adminassets/libs/datatables.net-buttons/js/dataTables.buttons.min.js">
    </script>
    <script src="<?php echo base_url(); ?>adminassets/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js">
    </script>
    ...
    <!-- Responsive examples -->
    <script src="<?php echo base_url(); ?>adminassets/libs/datatables.net-responsive/js/dataTables.responsive.min.js">
    </script>
    <script
        src="<?php echo base_url(); ?>adminassets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js">
    </script>
    ...
    dataTable = $('#unApprovedUsersList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "un-approved-user-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
    ...
    dataTable = $('#fundRequestList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "fund-request-list-grid-data",
            "type": "POST",
            "dataType": "json",
            complete: function(r) {
                $('#fundRequestList').lightGallery({
                    selector: '.item'
                });
            }
        },
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                ...
                if (data.request_status == 1 || data.request_status == 2) {
                    action += '<a href="javascript:void(0);" class="" data-id="' + data
                        .fund_request_id +
                        '"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" disabled >Accept</button></a>';

                    action += '<a href="javascript:void(0);" class="" data-id="' + data
                        .fund_request_id +
                        '"><button class="btn btn-outline-danger btn-xs m-l-5" type="button" disabled >Reject</button></a>';
                } else {
                    action +=
                        '<a href="javascript:void(0);" class="openPopupAcceptRequest" data-id="' +
                        data.fund_request_id +
                        '"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" >Accept</button></a>';

                    action +=
                        '<a href="javascript:void(0);" class="openPopupRejectRequest" data-id="' +
                        data.fund_request_id +
                        '"><button class="btn btn-outline-danger btn-xs m-l-5" type="button" >Reject</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#autoFundRequestList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "auto-fund-request-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                ...
                if (data.fund_status == 1 || data.fund_status == 2) {
                    action += '<a href="javascript:void(0);" class="" data-id="' + data.id +
                        '"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" disabled >Accept</button></a>';
                    ...
                    action +=
                        '<a href="javascript:void(0);" class="openPopupAcceptAutoRequest" data-id="' +
                        data.id +
                        '"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" >Accept</button></a>';

                    action +=
                        '<a href="javascript:void(0);" class="openPopupRejectAutoRequest" data-id="' +
                        data.id +
                        '"><button class="btn btn-outline-danger btn-xs m-l-5" type="button" >Reject</button></a>';

                    action +=
                        '<a href="javascript:void(0);" class="openPopupDeleteAutoId"  data-id="' +
                        data.id +
                        '"><button class="btn btn-danger btn-xs mr-1" type="button">Delete</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#withdrawRequestList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "withdraw-request-list-grid-data",
            "type": "POST",
            "dataType": "json",
            complete: function(r) {
                /* $('#withdrawRequestList').lightGallery({
                				selector: '.item'
                			}); */
            }
        },
    ...
    dataTable = $('#noticeList').DataTable({
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/edit-notice/' + data.notice_id +
                    '" class="openPopupNotice"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" title="edit">Edit</button></a>';

                if (data.status == 1) {
                    action +=
                        '<a title="Inactivate" class="success blockUnblock" href="" id="success-' +
                        data.notice_id +
                        '-tb_notice-notice_id-status"><button class="btn btn-outline-success btn-xs m-l-5" type="button" title="Inactivate">Inactivate</button></a>';
                } else {
                    action += '<a class="danger blockUnblock" href="" id="danger-' + data
                        .notice_id +
                        '-tb_notice-notice_id-status"><button class="btn btn-outline-danger btn-xs m-l-5" type="button" title="Activate">Activate</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#gameList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "game-name-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/edit-game/' + data.game_id +
                    '" class="openPopupEditGame"><button  class="btn btn-primary btn-xs mr-1" type="button"  title="edit">Edit</button></a>';
                ...
                action += '<a title="Off Day" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/off-day/' + data.game_id +
                    '" class="openPopupoffDayGame"><button  class="btn btn-primary btn-xs mr-1" type="button"  title="Off Day">market off day</button></a>';
    ...
    dataTable = $('#starlinegameList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "starline-game-name-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/edit-starline-game/' + data.game_id +
                    '" class="openPopupEditStarlineGame"><button  class="btn btn-primary btn-xs mr-1" type="button"  title="edit">Edit</button></a>';
                ...
                if (data.market_status == 1) {
                    action +=
                        '<a title="Market Close" class="success openCloseMarket" href="" id="success-' +
                        data.game_id +
                        '-tb_starline_games-game_id-market_status" ><button class="btn btn-success btn-xs mr-1" type="button" title="Market Close">Market Close</button></a>';
                } else {
                    action += '<a class="danger openCloseMarket" href="" id="danger-' + data
                        .game_id +
                        '-tb_starline_games-game_id-market_status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Market Open">Market Open</button></a>';
                }
    ...
    dataTable = $('#galidisswargameList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "galidisswar-game-name-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/edit-galidisswar-game/' + data.game_id +
                    '" class="openPopupEditgalidisswarGame"><button  class="btn btn-primary btn-xs mr-1" type="button"  title="edit">Edit</button></a>';
                ...
                if (data.market_status == 1) {
                    action +=
                        '<a title="Market Close" class="success openCloseMarket" href="" id="success-' +
                        data.game_id +
                        '-tb_gali_disswar_games-game_id-market_status" ><button class="btn btn-success btn-xs mr-1" type="button" title="Market Close">Market Close</button></a>';
                } else {
                    action += '<a class="danger openCloseMarket" href="" id="danger-' + data
                        .game_id +
                        '-tb_gali_disswar_games-game_id-market_status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Market Open">Market Open</button></a>';
                }
    ...
    dataTable2 = $('#allTransactionTable').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "all-transaction-table-grid-data",
            "type": "POST",
            "data": {
                user_id: user_id
            },
    ...
    dataTable2 = $('#inTransactionTable').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "credit-transaction-table-grid-data",
            "type": "POST",
            "data": {
                user_id: user_id
            },
    ...
    dataTable2 = $('#outTransactionTable').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "debit-transaction-table-grid-data",
            "type": "POST",
            "data": {
                user_id: user_id
            },
    ...
    dataTable = $('#imagesList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "slider-images-list-grid-data",
            "type": "POST",
            "dataType": "json",
            complete: function(r) {
                $('#imagesList').lightGallery({
                    selector: '.item'
                });
            }
        },
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a href="javascript:void(0);" class="openPopupDeleteImage"  data-id="' +
                    data.image_id +
                    '"><button class="btn btn-danger btn-xs mr-1" type="button">Delete</button></a>';
                ...
                if (data.status == 1) {
                    action +=
                        '<a title="Inactivate" class="success blockUnblock" href="" id="success-' +
                        data.image_id +
                        '-tb_slider_images-image_id-status"><button class="btn btn-success btn-xs mr-1" type="button" title="Inactivate">Inactivate</button></a>';
                } else {
                    action += '<a class="danger blockUnblock" href="" id="danger-' + data.image_id +
                        '-tb_slider_images-image_id-status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Activate">Activate</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable2 = $('#bidHistoryTable').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "user-bid-history-table-grid-data",
            "type": "POST",
            "data": {
                user_id: user_id
            },
    ...
    dataTable = $('#userQueryList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "users-querys-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
    ...
    dataTable = $('#gameResultHistory').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "result-history-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
    ...
    dataTable = $('#starlineGameResultHistory').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "starline-result-history-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
    ...
    $.ajax({
        ...
        success: function(data) {
            $.each(data, function(key, val) {
                ob2 += '<tr><td>' + val.sn + '</td><td>' + val.game_name + '</td><td>' + val
                    .result_date + '</td><td>' + val.open_date + '</td><td>' + val.close_date +
                    '</td><td>' + val.open_result + '</td><td>' + val.close_result + '</td></tr>'
            });
    ...
    $.ajax({
        ...
        success: function(data) {
            $.each(data, function(key, val) {
                ob2 += '<tr><td>' + val.sn + '</td><td>' + val.game_name + '</td><td>' + val
                    .result_date + '</td><td>' + val.open_date + '</td><td>' + val.open_result +
                    '</td></tr>'
            });
    ...
    dataTable = $('#galidisswarGameResultHistory').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "galidisswar-result-history-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
    ...
    dataTable = $('#subAdminList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "sub-admin-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
            ...
            render: function(a, b, data, d) {
                ...
                if (data.status == 1) {
                    action +=
                        '<a title="Inactivate" class="success blockUnblock" href="" id="success-' +
                        data.user_id +
                        '-tb_admin-id-status"><button class="btn btn-success btn-xs mr-1" type="button" title="Inactivate">Inactivate</button></a>';
                } else {
                    action += '<a class="danger blockUnblock" href="" id="danger-' + data.user_id +
                        '-tb_admin-id-status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Activate">Activate</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#tipsList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "tips-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                ...
                action += '<a title="view" href="' + base_url + admin + '/view-tips/' + data
                    .tips_id +
                    '"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" title="view">View</button></a>';

                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/edit-tips/' + data.tips_id +
                    '" class="openPopupEditTips"><button class="btn btn-primary btn-xs mr-1" type="button" title="edit">Edit</button></a>';

                if (data.status == 1) {
                    action +=
                        '<a title="Inactivate" class="success blockUnblock" href="" id="success-' +
                        data.tips_id +
                        '-tb_tips-tips_id-status"><button class="btn btn-success btn-xs mr-1" type="button" title="Inactivate">Inactivate</button></a>';
                } else {
                    action += '<a class="danger blockUnblock" href="" id="danger-' + data.tips_id +
                        '-tb_tips-tips_id-status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Activate">Activate</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#quesTable').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "ques-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a title="view" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/view-ques/' + data.ques_id +
                    '" class="openPopupViewques"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" title="view">View</button></a>';

                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/add-ques/' + data.ques_id +
                    '" class="openPopupAddques"><button class="btn btn-outline-primary btn-xs m-l-5" type="button" title="edit">Edit</button></a>';

                if (data.status == 1) {
                    action +=
                        '<a title="Inactivate" class="success blockUnblock" href="" id="success-' +
                        data.ques_id +
                        '-tb_chat_ques-ques_id-status"><button class="btn btn-outline-success btn-xs m-l-5" type="button" title="Inactivate">Inactivate</button></a>';
                } else {
                    action += '<a class="danger blockUnblock" href="" id="danger-' + data.ques_id +
                        '-tb_chat_ques-ques_id-status"><button class="btn btn-outline-danger btn-xs m-l-5" type="button" title="Activate">Activate</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#gameRouletteList').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "roulette-game-name-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
        ...
        columnDefs: [{
            ...
            render: function(a, b, data, d) {
                var action = '';
                action += '<a title="Edit" href="javascript:void(0);" data-href="' + base_url +
                    admin + '/add-roulette-game/' + data.game_id +
                    '" class="openPopupAddRouletteGame"><button  class="btn btn-primary btn-xs mr-1" type="button"  title="edit">Edit</button></a>';

                if (data.status == 1) {
                    action +=
                        '<a title="Inactivate" class="success blockUnblock" href="" id="success-' +
                        data.game_id +
                        '-tb_roulette_game-game_id-status" ><button class="btn btn-success btn-xs mr-1" type="button" title="Inactivate">Inactivate</button></a>';
                } else {
                    action += '<a class="danger blockUnblock" href="" id="danger-' + data.game_id +
                        '-tb_roulette_game-game_id-status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Activate">Activate</button></a>';
                }
                if (data.market_status == 1) {
                    action +=
                        '<a title="Market Close" class="success openCloseMarket" href="" id="success-' +
                        data.game_id +
                        '-tb_roulette_game-game_id-market_status" ><button class="btn btn-success btn-xs mr-1" type="button" title="Market Close">Market Close</button></a>';
                } else {
                    action += '<a class="danger openCloseMarket" href="" id="danger-' + data
                        .game_id +
                        '-tb_roulette_game-game_id-market_status"><button class="btn btn-danger btn-xs mr-1" type="button" title="Market Open">Market Open</button></a>';
                }
                return action;
            }
        }],
    ...
    dataTable = $('#roulettegameResultHistory').DataTable({
        ...
        "order": [0, "desc"],
        "ajax": {
            "url": base_url + "roulette-result-history-list-grid-data",
            "type": "POST",
            "dataType": "json"
        },
        "columns": [{
